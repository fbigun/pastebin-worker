...
欢迎来到由 **{{TOS_MAINTAINER}}** （“公司”，“我们”，“我们的”，“我们”）维护的粘贴板！

“服务条款”（“条款”、“服务条款”）规范了您对我们位于 **{{BASE_URL}}**（统称或分别称为“服务”）的网站的使用，由 **{{TOS_MAINTAINER}}** 运营。

我们的隐私政策也规范了您对我们服务的使用，并解释了我们如何收集、保护和披露您使用我们网页所产生的信息。

您的与我们之间的协议包括这些条款和我们的隐私政策（“协议”）。您承认您已阅读并理解协议，并同意受其约束。

如果您不同意（或无法遵守）协议，则您可能无法使用该服务，但请通过发送电子邮件至 **{{TOS_MAIL}}** 通知我们，以便我们尝试找到解决方案。这些条款适用于所有希望访问或使用服务的访客、用户和其他人。
...
{{TOS_MAINTAINER}} 有权但不承担义务监控和编辑用户提供的所有内容。

此外，通过或在此服务上找到的内容为 {{TOS_MAINTAINER}} 的财产或经授权使用。未经我们事先明确的书面许可，您不得分发、修改、传输、重新使用、下载、重新发布、复制或以任何形式使用此类内容，无论全部还是部分，用于商业目的或个人获利。
...
服务和其原始内容（不包括用户提供的内容）、功能和功能是，并将继续为 {{TOS_MAINTAINER}} 及其许可人的专有财产。服务受版权、商标以及其他国家和外国法律的保护。未经 {{TOS_MAINTAINER}} 事先书面同意，不得将我们的商标用于任何产品或服务。

## 6. 版权政策

我们尊重他人的知识产权。我们的政策是对任何声称在服务上发布的内 容侵犯了任何个人或实体的版权或其他知识产权（“侵权”）的指控做出回应。

如果您是版权所有者，或代表版权所有者授权，并且您认为版权作品被以构成版权侵权的方式复制，请通过电子邮件向 {{TOS_MAIL}} 提交您的索赔，邮件主题为：“版权侵权”，并在您的索赔中包括以下“DMCA 侵权通知和版权侵权索赔程序”部分中详细描述的侵权详情。
...
您可以通过电子邮件在{{TOS_MAIL}}联系我们的版权代理。

## 8. 错误报告和反馈

您可以通过以下方式直接向我们提供，或在第三方网站和工具中提供有关错误、改进建议、想法、问题、投诉以及其他与我们服务相关的事项（“反馈”）：直接发送至 {{TOS_MAIL}} 或通过第三方网站和工具。您承认并同意：（一）您不得保留、获取或主张对反馈的任何知识产权或其他权利、标题或利益；（二）公司可能拥有与反馈类似的发展想法；（三）反馈不包含您或任何第三方的机密信息或专有信息；（四）公司对反馈没有保密义务。如果由于适用的强制性法律，无法将反馈的所有权转让，您授予公司及其关联方独家、可转让、不可撤销、免费、可再许可、无限期和永久的权利，以任何方式和使用目的使用（包括复制、修改、创建衍生作品、发布、分发和商业化）反馈。

## 9. 链接到其他网站

我们的服务可能包含链接到非由 {{TOS_MAINTAINER}} 拥有或控制的第三方网站或服务。

{{TOS_MAINTAINER}} 不对任何第三方网站或服务的内 容、隐私政策或做法拥有控制权，也不承担任何责任。我们不保证这些实体/个人或其网站的提供内容。
...
请通过电子邮件发送您的反馈、评论、技术支持请求：**{{TOS_MAIL}}**。
